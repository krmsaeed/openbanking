...
export default function Login() {
    ...
    if (step === 1) {
        return (
            <PageHeader>
                <Card padding="none">
                    <CardHeader>
                        <Box className="bg-primary mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-2xl">
                            <PhoneIcon className="h-6 w-6 text-white" />
                        </Box>

                        <CardTitle className="text-center">ورود به حساب</CardTitle>
    ...
    return (
        <PageHeader backText="تغییر شماره" onBack={() => setStep(1)}>
            <Card padding="none">
                <CardHeader>
                    <Box className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-green-600">
                        <PhoneIcon className="h-6 w-6 text-white" />
                    </Box>
