...
export async function POST(req: NextRequest) {
    ...
    // helper to safely normalize unknown service responses
    ...
    // If caller passed processId at top-level (Postman `get-customer-info` example), dispatch accordingly
    ...
    // If caller asked to run the virtual-open-deposit service with a { body: { code } }
    ...
    // Fallback: call the raw sendMessage helper
