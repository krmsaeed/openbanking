...
return (
    <Box className="space-y-4">
        <Box className="mx-auto w-full max-w-xl">
            <Box className="relative overflow-hidden rounded-lg border-1 bg-gray-200 p-2">
                <video
                    ref={videoRef}
                    autoPlay
                    playsInline
                    muted
                    className="h-64 w-full border-1 border-dashed border-gray-800 object-cover p-2"
                />
