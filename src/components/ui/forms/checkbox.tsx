...
const checkboxVariants = {
    ...
    custom: {
        ...
        unselected: 'border-gray-200 text-gray-700 hover:border-primary hover:text-gray-main',
    },
    outline: {
        base: 'transition-all duration-200 rounded-lg font-medium border-2',
        selected: 'border-primary bg-primary/10 text-primary',
        unselected: 'border-gray-200 text-gray-700 hover:border-primary hover:text-primary',
    },
    solid: {
        base: 'transition-all duration-200 rounded-lg font-medium border-2',
...
export const Checkbox: React.FC<CheckboxProps> = ({
    ...
    const variantStyles = checkboxVariants[variant as keyof typeof checkboxVariants];
