...
const Typography = ({
    ...
    const renderP = (extraClass = '') => (
        <p
            className={mergeClasses('text-base', extraClass, propClass, className)}
            onClick={onClick}
        >
            {children}
        </p>
    ...
    switch (v) {
        case 'h1':
            return (
                <h1
                    className={mergeClasses('text-6xl font-bold', propClass, className)}
                    onClick={onClick}
                >
                    {children}
                </h1>
        ...
        case 'h2':
            return (
                <h2
                    className={mergeClasses('text-5xl font-bold', propClass, className)}
                    onClick={onClick}
                >
                    {children}
                </h2>
        ...
        case 'h3':
            return (
                <h3
                    className={mergeClasses('text-4xl font-bold', propClass, className)}
                    onClick={onClick}
                >
                    {children}
                </h3>
        ...
        case 'h4':
            return (
                <h4
                    className={mergeClasses('text-3xl font-bold', propClass, className)}
                    onClick={onClick}
                >
                    {children}
                </h4>
        ...
        case 'h6':
            return (
                <h5
                    className={mergeClasses('text-2xl font-bold', propClass, className)}
                    onClick={onClick}
                >
                    {children}
                </h5>
        ...
        case 'subtitle1':
            return (
                <h6
                    className={mergeClasses('text-lg font-medium', propClass, className)}
                    onClick={onClick}
                >
                    {children}
                </h6>
        ...
        case 'subtitle2':
            return (
                <h6
                    className={mergeClasses('text-base font-medium', propClass, className)}
                    onClick={onClick}
                >
                    {children}
                </h6>
