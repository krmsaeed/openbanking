...
const DismissibleToast: React.FC<DismissibleToastProps> = ({ t, type = 'info', message }) => {
    const icons = {
        success: <CheckCircleIcon className="ml-2 h-5 w-5 text-(--color-success-500)" />,
        error: <XCircleIcon className="ml-2 h-5 w-5 text-(--color-error-500)" />,
        warning: <ExclamationTriangleIcon className="ml-2 h-5 w-5 text-(--color-warning-500)" />,
    ...
    const colors = {
        ...
        error: 'border-[var(--color-error-200)] bg-[var(--color-error-100)] dark:border-[var(--color-error-100)] dark:bg-[var(--color-error-300)]',
        warning:
            'border-[var(--color-warning-200)] bg-[var(--color-warning-100)] dark:border-[var(--color-warning-100)] dark:bg-[var(--color-warning-300)]',
        info: 'border-[var(--color-info-200)] bg-[var(--color-info-100)] dark:border-[var(--color-info-100)] dark:bg-[var(--color-info-300)]',
    };
